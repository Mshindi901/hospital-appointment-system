...
router.get('/patient-history/hospital/:id', authenticate, authorize('manager', 'staff'), getAllPatientHistoryByHospital);
...
router.put('/patient-history/:id', authenticate, authorize('staff'), updatePatientHistory);
